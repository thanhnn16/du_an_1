...
public class BestSellCosmeticAdapter extends RecyclerView.Adapter<BestSellCosmeticAdapter.CosmeticViewHolder> {

    private final List<Cosmetics> cosmeticsList;
    Context context;

    public BestSellCosmeticAdapter(Context context, ArrayList<Cosmetics> cosmeticsList) {
